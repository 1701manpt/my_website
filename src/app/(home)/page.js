...
export default function Home() {
  ...
  return (
    <div className="grid grid-cols-1 grid-flow-row lg:gap-8 gap-4">
      {dataPosts.map((post, i) => {
        return (
          <div key={post.id} className="bg-white p-4 rounded shadow-lg">
            ...
            <div className="sm:float-left mr-4">
              <Image
                src="/background.jpg"
              ...
              />
              <div className="flex justify-around mt-4 shadow rounded">
                <Link
                  href={"/posts/" + post.id}
            ...
            <div className="py-1 sm:line-clamp-[15] line-clamp-[7]">
              {post.contentShort}
            </div>
            <Link
              href={"/posts/" + post.id}
            ...
            >
              <div className="hover:underline">Đọc thêm</div>
              <div>{">>>"}</div>
            </Link>
          </div>
        );
